...
# READER_SHARED_LIB is defined later. That's why = is used instead of :=
READER_DARWIN_SHARED_LDFLAGS=-install_name '@rpath/$(READER_SHARED_LIB)'
else
...
READER_SHARED_LDFLAGS:=$(READER_COMMON_LDFLAGS) -shared $(READER_DARWIN_SHARED_LDFLAGS)
